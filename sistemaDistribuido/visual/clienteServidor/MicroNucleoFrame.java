...
public class MicroNucleoFrame extends Frame implements WindowListener,Escribano,ParMaquinaProceso{
	...
	public MicroNucleoFrame(){
		super("Proyecto Final Buzones y Transmisi�n Rala");
	...
	class ManejadorBotones implements ActionListener{
		...
		public void actionPerformed(ActionEvent e){
			...
			if (com.equals("Cliente Nestor")){
				levantarProcesoFrame(new sistemaDistribuido.visual.clienteServidor.Nestor.ClienteFrame(MicroNucleoFrame.this));
			}
			else if (com.equals("Servidor Nestor")){
				levantarProcesoFrame(new sistemaDistribuido.visual.clienteServidor.Nestor.ServidorFrame(MicroNucleoFrame.this));
			}
			else if(com.equals("Cliente Paco")) //Por mientras uso mi cliente y servidor para probar
				levantarProcesoFrame(new sistemaDistribuido.visual.clienteServidor.Paco.ClienteFrame(MicroNucleoFrame.this));
			else if(com.equals("Servidor Paco")) //Por mientras uso mi cliente y servidor para probar
				levantarProcesoFrame(new sistemaDistribuido.visual.clienteServidor.Paco.ServidorFrame(MicroNucleoFrame.this));
